...
function for extracting specific features from .h5 file formate ) according to my
...
def open_h5_file_read(h5filename):
    ...
    """
    return tables.open_file(h5filename, mode='r')    # Edited line by Me (Umesh Yadav)

# Some/ Most functions below are also edited by Me (Umesh Yadav) as per my requirements for the project
